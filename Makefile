...
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX := https://releases.hashicorp.com/terraform-provider-launchdarkly/2.9.3
export TERRAFORM_NATIVE_PROVIDER_BINARY := terraform-provider-launchdarkly_v2.9.3
...
IMAGES = provider-jet-launchdarkly provider-jet-launchdarkly-controller
